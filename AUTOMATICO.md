...
HubSpot, Zendesk y la sincronización duradera F03-03 tienen propuestas locales revisadas. F03-03 pasó 29/29 pruebas en Node 22 y 26, seis mutantes y la matriz global SQL/Auth/Storage de 208 casos; se corrigieron tres fallos de visibilidad, origen de rechazos y mezcla de cuentas. S01/S02 reales siguen pendientes de acceso legítimo. El siguiente trabajo independiente de esta fase es F03-04, alias con aprobación humana y recuperación del historial. El cierre sigue siendo serial: F03-01 antes de aceptar F03-02. La falta de datos del cliente no impide preparar y probar código independiente, ni autoriza saltarse gates o declarar aceptación por fixtures. Cambios locales de infraestructura no conceden permiso sobre cuentas ni datos externos.
