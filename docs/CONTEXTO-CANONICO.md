...
El usuario pidió comprobar y equiparar el paso a paso con el calibre de Likida. Entrada vigente: [construccion/README](../construccion/README.md); 60 fichas específicas, grafo v4 (55IDs conservados +5notificaciones), prepare/verify/accept y recuperación supervisada. F00 sólo acredita preparación sintética; piloto/producción requieren sus verificaciones externas. Gates presentes no equivalen a aprobados, y aún faltan gates de producto. No regenerar grafo ni editar estado para simular aceptación.
