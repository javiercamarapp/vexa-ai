...
| Auth | Métodos OAuth y redirects, usuarios/organizaciones/membresías autorizadas. | Login, renovación, selección A/B y revocación reales. |
...
| Evaluación | Dos anotadores, adjudicador, gold y sponsor reales; entrevistas consentidas. | Holdout externo y métricas humanas con denominadores; no labels sintéticos como gold. |
...
Estos aportes no ocultan programación pendiente: revisiones de notificaciones, robustez/restore, carga/caos, aceptación de release y auditoría integral conservan su estado técnico separado.
