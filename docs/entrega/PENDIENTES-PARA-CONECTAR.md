...
- ReleaseF08-01/02: inventario y smoke ya implementados y ensayados, pero falta integrar sus entradas de aceptación al control-plane. Es programación de control pendiente, no una credencial.
