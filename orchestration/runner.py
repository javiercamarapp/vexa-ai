...
def acceptance_environment(task, row):
    ...
    live_gates = {
        ...
        'F08-06': ('VEXA_CLOSURE_DOSSIER', 'VEXA_CLOSURE_AUTHORIZATION',
                   'VEXA_CLOSURE_APPROVAL_REFERENCE'),
        'F08-04': ('VEXA_PERMISSIONS_MANIFEST', 'VEXA_PERMISSIONS_AUTHORIZATION',
                   'VEXA_PERMISSIONS_APPROVAL_REFERENCE'),
    }
