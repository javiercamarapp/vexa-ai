...
export interface Mapping {columns:{id:string;text:string;date?:string|null;order?:string|null;sku?:string|null;amount?:string|null;currency?:string|null;customer?:string|null};timezone:string;dateFormat:'iso'|'ymd'|'dmy'|'mdy';currency:string|null;sheet?:string|null}
