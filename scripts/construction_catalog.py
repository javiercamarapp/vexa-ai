...
add('F04-03','apps/web/src/app/(workspace)/analysis/page.tsx|apps/web/src/app/api/extraction/route.ts|apps/web/src/app/api/internal/extraction/route.ts|apps/web/src/components/extraction-panel.tsx|apps/web/src/components/workspace/navigation.tsx|apps/web/src/lib/extraction/server.ts|packages/gateway/index.mjs|packages/intelligence/EXTRACTION-RUNTIME.md|packages/intelligence/api.d.mts|packages/intelligence/api.mjs|packages/intelligence/extract.mjs|packages/intelligence/extraction-repository.mjs|packages/intelligence/hosted.d.mts|packages/intelligence/hosted.mjs|packages/intelligence/queue.mjs|packages/intelligence/redact.mjs|packages/intelligence/runtime.d.mts|packages/intelligence/runtime.mjs|packages/intelligence/source-reader.mjs|supabase/migrations/0012_extraction_redaction.sql|supabase/migrations/0014_extraction_queue.sql|supabase/operations/extraction-cron.sql',
...
add('F04-04','apps/web/src/app/(workspace)/analysis/[id]/page.tsx|apps/web/src/app/api/extraction/[id]/evidence/route.ts|apps/web/src/components/evidence-panel.tsx|apps/web/src/lib/extraction/evidence.ts|packages/intelligence/EVIDENCE.md|packages/intelligence/evidence-repository.d.mts|packages/intelligence/evidence-repository.mjs',
...
add('F04-05','packages/problems/contracts.mjs|packages/problems/repository.mjs|packages/problems/repository.d.mts|packages/problems/runtime.mjs|packages/problems/runtime.d.mts|packages/gateway/embeddings.mjs|packages/jobs/durable/runtime.mjs|packages/jobs/durable/runtime.d.mts|supabase/migrations/0016_problem_runtime.sql|apps/web/src/lib/problems/contracts.ts|apps/web/src/lib/problems/server.ts|apps/web/src/components/problems-panel.tsx|apps/web/src/app/api/problems/route.ts|apps/web/src/app/api/problems/[id]/route.ts|apps/web/src/app/api/internal/problems/route.ts|apps/web/src/app/(workspace)/problems/page.tsx|apps/web/src/app/(workspace)/problems/[id]/page.tsx|packages/problems/OPERATIONS.md',
...
add('F04-06','packages/problems/causality.mjs|packages/problems/causality.d.mts|supabase/migrations/0017_problem_causality.sql|apps/web/src/app/api/problems/[id]/causality/route.ts|apps/web/src/components/cause-evidence.tsx|apps/web/src/app/(workspace)/problems/[id]/page.tsx',
...
add('F04-07','packages/intelligence/evaluation/evaluate.mjs|packages/intelligence/evaluation/cli.mjs|packages/intelligence/evaluation/README.md|docs/blueprint/evaluation-protocol.json',
...
add('F06-05','packages/interventions/index.mjs|packages/interventions/index.d.mts|packages/interventions/state.mjs|packages/interventions/OPERATIONS.md|packages/workspace-service/index.mjs|supabase/migrations/0026_interventions.sql|apps/web/src/lib/interventions/server.ts|apps/web/src/app/api/interventions/route.ts|apps/web/src/app/api/interventions/[id]/route.ts|apps/web/src/components/interventions/panel.tsx|apps/web/src/app/(workspace)/interventions/page.tsx|apps/web/src/components/recommendations/panel.tsx',
...
add('F06-06','packages/briefs/index.mjs|packages/briefs/index.d.mts|packages/briefs/build.mjs|packages/briefs/OPERATIONS.md|supabase/migrations/0027_briefs.sql|apps/web/src/lib/briefs/server.ts|apps/web/src/app/api/briefs/route.ts|apps/web/src/app/api/briefs/[id]/route.ts|apps/web/src/app/api/briefs/[id]/export/route.ts|apps/web/src/components/briefs/panel.tsx|apps/web/src/app/(workspace)/briefs/page.tsx|apps/web/src/app/(workspace)/briefs/[id]/page.tsx',
...
add('F06-08','packages/notifications/OPERATIONS.md|packages/notifications/catalog.mjs|packages/notifications/contracts.mjs|packages/notifications/index.d.mts|packages/notifications/index.mjs|packages/platform/src/db.ts|supabase/migrations/0028_notification_center.sql|apps/web/src/lib/notifications/server.ts|apps/web/src/app/api/notifications/route.ts|apps/web/src/app/api/notifications/preferences/route.ts|apps/web/src/app/api/notifications/[id]/read/route.ts|apps/web/src/components/notifications/panel.tsx|apps/web/src/app/(workspace)/notifications/page.tsx|apps/web/src/app/(workspace)/settings/notifications/page.tsx|apps/web/src/components/workspace/navigation.tsx',
