...
export async function exam02(t,h,factory,{only,processEntry,reconcile}={}){
 ...
 await sub('D02-15 expired reconciliation retains reservation and bytes without completing work',async()=>{
